...
const CreatePost = () => {
    ...
    const handleSurpriseMe = () => {
           const handlePrompt=getRandomPrompt()
    ...
    return (
        ...
        <div className="mt-10">
         ...
         <button type='submit' className='mt-3 text-white bg-[#6469ff] rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>{loading? "sharing..." : "share with the community"}</button>
          </div>
            </form>
        </div>
    )
